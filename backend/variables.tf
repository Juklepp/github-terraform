...
variable "sa_backend_location" {
  type = string
  description = "Location of the storage account for the backend"
}
...
variable "kv_backend_location" {
  type = string
  description = "Location of the key vault for the backend"
}
